 ...
 * @Description: Excel解析接口
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: DorenWu DorenWu@msyc.cc
 * @Date: 2017年05月23日 16:27:35
 * @Version: V2.0.0
 * @Modify-by: DorenWu DorenWu@msyc.cc
 * @Modify-date: 2017年05月23日 16:27:35
 ...
 * @Date: 2017年05月23日 16:27:35
 */
public interface MsOnionExcelReader<T extends MsOnionBaseReaderView> {
	 ...
	 */
	List<T> getRowObjectList();

	/**
	 * 获取指定sheet的数据页
	 * @throws MsOnionException                the ms onion exception
	 */
	void parse() throws MsOnionException;
	 ...
	 */
	List<String> getTitleList() throws MsOnionException;

	/**
	 * 获取到标题所在的行
	 * @return 行
	 */
	Integer getTitleLine();
}
