 ...
 * PooledKryoFactory
 *
 * @Title: MsOnionPooledKryoFactory.java
 * @Package: cc.msonion.carambola.parent.ext.lang.serialize.kryo
 * @Description: PooledKryoFactory
 ...
 * PooledKryoFactory
 *
 * @ClassName: MsOnionPooledKryoFactory
 * @Description: PooledKryoFactory
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年4月30日 下午1:48:16
 */
final class MsOnionPooledKryoFactory extends BasePooledObjectFactory<Kryo> {
     ...
     */
    private Kryo createKryo() throws MsOnionException {
        try {
