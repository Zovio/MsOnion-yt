 ...
 * @ClassName: MsOnionServiceExt
 * @Description: MsOnionServiceExt
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年2月17日 下午5:11:38
 */
public abstract class MsOnionServiceExt<T extends MsOnionBasePojoAdapter, E extends MsOnionBaseExampleAdapter> extends MsOnionMQService<T, E> {

    /**
     * MsOnionServiceExt 当前实现类的实例对象，方便于多线程中获取当前this
     */
    private MsOnionServiceExt msOnionServiceExt = this;
...
//     */
//    @Autowired
//    private MsOnionRocketMQProducerExt msOnionRocketMQProducerExt;
//
//    /**
//     * 发送MQ的线程池
//     */
...
//     */
//    @Override
//    public int save(MsOnionApiVersion apiVersion, MsOnionParameterAdapter parameter, T record)
// throws MsOnionIllegalArgumentException, MsOnionException {
...
//     */
//    @Override
//    public int updateByPrimaryKey(MsOnionApiVersion apiVersion, MsOnionParameterAdapter parameter, T record)
// throws MsOnionIllegalArgumentException, MsOnionException {
...
//
//        if (result <= 0 || null == t) {
//            getMsOnionLogger().info(msOnionServiceExt.getClass().getName(),
...
//
//                    // 获取 Topic
//                    String topic = msOnionRocketMQProducerExt.getTopic();
//                    String keys = t.getId();
...
//                    getMsOnionLogger().error(msOnionServiceExt.getClass().getName(), e,
...
//                        idx, action.getValue(), topic, tags, keys, data, t));
//
//        MsOnionRocketMQProducer rocketMQProducer = msOnionRocketMQProducerExt.getMsOnionRocketMQProducer();
//
...
//
//        // 设置消息延时
//        if (msOnionRocketMQProducerExt.getDelayTimeLevel() > MsOnionRocketMQConstants.DEFAULT_DELAY_TIME_LEVEL) {
//            message.setDelayTimeLevel(msOnionRocketMQProducerExt.getDelayTimeLevel());
//        }
//
//        try {
//            // 设置发送消息Body
...
//        } catch (Exception ex) {
//            // 打印日志
//            this.getMsOnionLogger().error(msOnionServiceExt.getClass().getName(), ex,
...
//     */
//    public MsOnionRocketMQProducerExt getMsOnionSimpleRocketMQProducerExt() {
//        return msOnionRocketMQProducerExt;
//    }
//

    ///////////////////// Redis配置，从ZK中读取 ### Begin //////////////////////
...
////        return super.getRedisCacheExpire();
//        try {
//            long redisGlobalCacheExpire = MsOnionZookeeperUtils.getRedisGlobalCacheExpire(getMsOnionDomain(),
//                    getMsOnionCuratorZookeeperClient(), getRetryPolicy());
//            // 由于ZK中存储都是long ，因此强类型转换
//            return (int) redisGlobalCacheExpire;
//        } catch (MsOnionException e) {
//            getMsOnionLogger().error(msOnionServiceExt.getClass().getName(), e);
//            // 默认为1天，24小时
//            // 由于ZK中存储都是long ，因此强类型转换
//            return (int) MsOnionZookeeperUtils.DEFAULT_REDIS_CACHE_GLOBAL_EXPIRE;
//        }
//    }
...
////        return super.isDisabledRedisQueryCache();
//        try {
//            long redisCacheGlobalQueryDisabled = MsOnionZookeeperUtils.getRedisCacheGlobalQueryDisabled(getMsOnionDomain(),
//                    getMsOnionCuratorZookeeperClient(), getRetryPolicy());
//            // >= 2 启用Redis缓存，0、1 禁用缓存 。
//            return redisCacheGlobalQueryDisabled >= MsOnionZookeeperUtils.DEFAULT_REDIS_CACHE_GLOBAL_QUERY_DISABLED ? false : true;
//        } catch (MsOnionException e) {
//            getMsOnionLogger().error(msOnionServiceExt.getClass().getName(), e);
//            // 默认都不禁用
//            return false;
