...
/**
 * Netty客户端Java方式Channel初始化器
 *
 * @Title: MsOnionNettyClient.java
 * @Package: cc.msonion.carambola.parent.ext.netty.client
 * @Description: Netty客户端Java方式Channel初始化器
 ...
 */
@Component
public class MsOnionJavaNettyClientChannelInitializer extends MsOnionNettyClientChannelInitializer {
