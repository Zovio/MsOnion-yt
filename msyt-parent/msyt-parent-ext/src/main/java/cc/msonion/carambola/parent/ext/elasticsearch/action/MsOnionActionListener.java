 ...
 * @Title: MsOnionActionListener.java
 * @Package: cc.msonion.carambola.parent.ext.elasticsearch.action
 * @Description: Elasticsearch ActionListener
...
/**
 * Elasticsearch ActionListener
 * @ClassName: MsOnionActionListener
 * @Description: Elasticsearch ActionListener
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年6月5日 下午1:48:16
 */
public interface MsOnionActionListener extends ActionListener {
