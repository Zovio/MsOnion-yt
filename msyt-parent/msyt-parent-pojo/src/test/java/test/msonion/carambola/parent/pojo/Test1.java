...
* @Date: 2017年2月11日 下午6:11:44 
* @Version: V2.0.0
* @Modify-by: HeroCao hero-cao@msyc.cc
* @Modify-date: 2017年2月11日 下午6:11:44  
...
import cc.msonion.carambola.parent.pojo.annotation.MsOnionImageField;
...
public class Test1 {
	...
	@MsOnionImageField(imageSizeMode = MsOnionImageSizeMode.MIDDLE)
	private String middleImageUrl;

	@MsOnionImageField(imageSizeMode = MsOnionImageSizeMode.BIG)
