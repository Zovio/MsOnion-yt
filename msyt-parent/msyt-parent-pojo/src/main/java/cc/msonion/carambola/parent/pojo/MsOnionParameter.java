 ...
 *
 */
public class MsOnionParameter extends MsOnionBaseParameter {

    /**
     *  是否安全结果，也就是所有返回值的方法，是否对data进行加密，默认是不加密的
     */
    private boolean securityResult = false;
     ...
     * @return 是否安全结果，也就是所有返回值的方法，是否对data进行加密，默认是加密的
     */
    ...
    /**
     * 是否安全结果，也就是所有返回值的方法，是否对data进行加密，默认是不加密的
     * @param securityResult 是否加密结果（data）
     * @return 返回MsOnionParameter实例对象
     */
    public MsOnionParameter setSecurityResult(boolean securityResult) {
