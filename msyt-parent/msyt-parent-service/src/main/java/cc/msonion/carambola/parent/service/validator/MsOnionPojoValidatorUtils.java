...
package cc.msonion.carambola.parent.service.validator;

/**
 * @Title: MsOnionPojoValidatorUtils.java
 * @Package: cc.msonion.carambola.parent.ext.common
 * @Description: Hibernate Validator 校验POJO
...
/**
 * 放在其他包下，会和tomcat底下el jar包冲突，引用时请注意
 *
 * @ClassName: MsOnionPojoValidatorUtils
 * @Description: Hibernate Validator 校验POJO
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年04月01日
 *
 */
public final class MsOnionPojoValidatorUtils {

    private MsOnionPojoValidatorUtils() {
