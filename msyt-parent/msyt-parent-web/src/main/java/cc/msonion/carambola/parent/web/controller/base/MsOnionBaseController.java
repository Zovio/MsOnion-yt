...
package cc.msonion.carambola.parent.web.controller.base;
...
/**
 * @Title: MsOnionBaseController.java
 * @Package: cc.msonion.carambola.parent.web.controller.base
 * @Description: 架构父类Controller，封装公共功能
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年2月11日 上午11:09:57
 * @Version: V2.0.0
 * @Modify-by: HeroCao hero-cao@msyc.cc
 * @Modify-date: 2017年2月11日 上午11:09:57
 * @Modify-version: V2.0.0
 * @Modify-description: 架构父类Controller，封装公共功能
 */

/**
 * @ClassName: MsOnionBaseController
 * @Description: 架构父类Controller
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年2月11日 上午11:09:57
 */
public abstract class MsOnionBaseController {
     ...
     * @return ZK重试策略
     */
    public MsOnionRetryNTimes getMsOnionRetryNTimes() {
        return msOnionRetryNTimes;
    }
