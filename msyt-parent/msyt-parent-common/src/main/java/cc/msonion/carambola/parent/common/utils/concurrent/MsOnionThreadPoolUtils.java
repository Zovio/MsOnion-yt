...
package cc.msonion.carambola.parent.common.utils.concurrent;

/**
 * @Title: MsOnionThreadPoolUtils.java
 * @Package: cc.msonion.carambola.parent.common.utils.concurrent
 * @Description: 线程池工具类
...
/**
 * @ClassName: MsOnionThreadPoolUtils
 * @Description: 线程池工具类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年06月23日
 *
 */
public final class MsOnionThreadPoolUtils  {


    private MsOnionThreadPoolUtils() {
