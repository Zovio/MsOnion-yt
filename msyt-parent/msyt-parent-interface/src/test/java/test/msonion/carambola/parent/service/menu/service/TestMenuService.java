...
package test.msonion.carambola.parent.service.menu.service;
...
import test.msonion.carambola.parent.service.menu.TestMenu;
import test.msonion.carambola.parent.service.menu.TestMenuExample;
 ...
 *
 */
public interface TestMenuService extends MsOnionBaseService<TestMenu, TestMenuExample> {
     ...
     * @throws MsOnionException 异常
     */
    MsOnionResult saveOrUpdate(MsOnionApiVersion apiVersion, TestMenu menu) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException 异常
     */
    List<TestMenu> getChildMenusByPidx(MsOnionApiVersion apiVersion, Long pidx) throws MsOnionIllegalArgumentException, MsOnionException;
