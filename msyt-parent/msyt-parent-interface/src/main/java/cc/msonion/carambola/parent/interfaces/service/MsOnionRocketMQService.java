...
/**
 * RocketMQ相关操作Service
 * @Title: MsOnionRocketMQService.java
 * @Package: cc.msonion.carambola.parent.interfaces.service.base
 * @Description: MsOnionRocketMQService
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年5月19日 下午3:34:54
 * @Version: V2.0.0
 * @Modify-by: HeroCao hero-cao@msyc.cc
 * @Modify-date: 2017年5月19日 下午3:34:54
 ...
 * @ClassName: MsOnionRocketMQService
 * @Description: MsOnionRocketMQService
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年5月19日 下午3:34:54
 */
@Deprecated
public abstract class MsOnionRocketMQService<T extends MsOnionBasePojoAdapter, E extends MsOnionBaseExampleAdapter>
        extends MsOnionService<T, E> implements MsOnionBaseRedisService<T, E> {
