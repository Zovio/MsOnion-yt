...
/**
 * Base缓存Service，提供Redis缓存操作相关接口
 * @Title: MsOnionBaseCacheService.java
 * @Package: cc.msonion.carambola.parent.interfaces.service.base
 * @Description: MsOnionBaseCacheService
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年2月17日 下午3:34:54
 * @Version: V2.0.0
 * @Modify-by: HeroCao hero-cao@msyc.cc
 * @Modify-date: 2017年5月10日 下午3:34:54
...
/**
 * Base缓存Service，提供Redis缓存操作相关接口
 * @ClassName: MsOnionBaseCacheService
 * @Description: MsOnionBaseCacheService
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年5月10日 下午3:34:54
 */
public interface MsOnionBaseCacheService {
