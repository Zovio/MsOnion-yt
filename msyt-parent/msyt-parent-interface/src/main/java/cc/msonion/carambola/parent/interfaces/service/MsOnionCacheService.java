...
/**
 * MsOnionCacheService，提供Cache操作相关接口
 *
 * @Title: MsOnionCacheService.java
 * @Package: cc.msonion.carambola.parent.interfaces.service
 * @Description: MsOnionCacheService
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年5月8日 下午3:34:54
 * @Version: V2.0.0
 * @Modify-by: HeroCao hero-cao@msyc.cc
 * @Modify-date: 2017年5月8日 下午3:34:54
 ...
 * MsOnionCacheService，提供Cache操作相关接口
 *
 * @ClassName: MsOnionCacheService
 * @Description: MsOnionCacheService
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年5月1日 下午3:34:54
 */
public abstract class MsOnionCacheService implements MsOnionBaseCacheService {
