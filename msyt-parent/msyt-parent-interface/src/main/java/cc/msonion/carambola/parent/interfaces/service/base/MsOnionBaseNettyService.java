...
/**
 * MsOnionBaseNettyService，提供Netty操作相关接口
 * @Title: MsOnionBaseNettyService.java
 * @Package: cc.msonion.carambola.parent.interfaces.service.base
 * @Description: MsOnionBaseNettyService
 ...
 * @ClassName: MsOnionBaseNettyService
 * @Description: MsOnionBaseNettyService
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年4月14日 下午3:34:54
 */
public interface MsOnionBaseNettyService<T extends MsOnionBasePojoAdapter, E extends MsOnionBaseExampleAdapter> extends MsOnionBaseService<T, E> {
