...
/**
 * @Title: ItemBasicOfficialRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.item.service.redis.key.impl
 * @Description: 商品模块商品Redis的Key生成器实现类
...
/**
 * @ClassName: ItemBasicOfficialRedisKeyGeneratorImpl
 * @Description: 商品模块商品Redis的Key生成器实现类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo johnny-woo@msyc.cc
 * @Date: 2017年6月22日 上午11:10:21
 */
@Component
public class ItemBasicOfficialRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<ItemBasicOfficial, ItemBasicOfficialExample> {
