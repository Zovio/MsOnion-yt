...
/**
 * @Title: ItemAttributeOfficialRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.item.service.redis.key.impl
 * @Description: 商品模块商品属性值Redis的Key生成器实现类
...
/**
 * @ClassName: ItemAttributeOfficialRedisKeyGeneratorImpl
 * @Description: 商品模块商品属性值Redis的Key生成器实现类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo johnny-woo@msyc.cc
 * @Date: 2017年6月24日 下午16:42:21
 */
@Component
public class ItemAttributeOfficialRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<ItemAttributeOfficial, ItemAttributeOfficialExample> {
