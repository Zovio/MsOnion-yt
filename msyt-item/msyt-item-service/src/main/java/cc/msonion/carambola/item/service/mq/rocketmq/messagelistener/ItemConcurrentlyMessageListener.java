...
package cc.msonion.carambola.item.service.mq.rocketmq.messagelistener;
 ...
 *
 * @Title: ItemConcurrentlyMessageListener.java
...
/**
 * RocketMQ Push 消费者，普通消息（无序消息）监听器
 * @ClassName: ItemConcurrentlyMessageListener
 * @Description: ItemConcurrentlyMessageListener
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年5月29日 下午5:11:38
 */
public class ItemConcurrentlyMessageListener implements MsOnionRocketMQMessageListenerConcurrently {
