...
/**
 * @Title: WarehouseTypeService.java
 * @Package: cc.msonion.carambola.warehouse.service
 * @Description: 商品仓库类型service
 ...
 *
 */
public interface WarehouseTypeService extends MsOnionBaseService<WarehouseType, WarehouseTypeExample> {
     ...
     */
    MsOnionResult inspectParameter(MsOnionApiVersion apiVersion, Integer type, String param) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     */
    MsOnionResult addOrUpdateWarehouseType(MsOnionApiVersion apiVersion,
                                           WarehouseType warehouseType) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException 异常
     */
    MsOnionResult getWarehouseList(MsOnionApiVersion apiVersion) throws MsOnionIllegalArgumentException, MsOnionException;
