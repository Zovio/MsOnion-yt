...
/**
 * @Title: WarehouseOfficialService.java
 * @Package: cc.msonion.carambola.warehouse.service
 * @Description: 正式商品仓库service
...
/**
 * @ClassName: WarehouseOfficialService
 * @Description: 正式商品仓库service
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年06月23日
 */
public interface WarehouseOfficialService extends MsOnionBaseService<WarehouseOfficial, WarehouseOfficialExample> {
     ...
     */
    MsOnionResult getWarehouseOfficialByItemOfficialIdx(MsOnionApiVersion apiVersion, Long itemOfficialIdx)
     ...
     */
    MsOnionResult addWarehouseOfficial(MsOnionApiVersion apiVersion, WarehouseOfficial warehouseOfficial)
            throws MsOnionIllegalArgumentException, MsOnionException;
