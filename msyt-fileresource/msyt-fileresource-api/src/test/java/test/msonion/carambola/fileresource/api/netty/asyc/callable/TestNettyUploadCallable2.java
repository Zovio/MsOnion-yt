package test.msonion.carambola.fileresource.api.netty.asyc.callable;
 ...
 */
public class TestNettyUploadCallable2 extends MsOnionNettyUploadCallable<MsOnionNettyResponse, MsOnionNettyRequest, TestUploadService> {
    /**
     ...
     */
    public TestNettyUploadCallable2(MsOnionNettyClientAdapter client, String method, Object... parameters) {
     ...
     * @param parameters SERVICE实现类中方法的参数
     */
    public TestNettyUploadCallable2(String messageId, MsOnionNettyClientAdapter client, String method, Object... parameters) {
