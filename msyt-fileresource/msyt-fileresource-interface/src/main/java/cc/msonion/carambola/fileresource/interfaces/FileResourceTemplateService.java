...
/**
 * @Title: FileResourceTemplateService.java
 * @Package: cc.msonion.carambola.fileresource.interfaces
 * @Description: 文件模板service
...
/**
 * @ClassName: FileResourceTemplateService
 * @Description: 文件模板service
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年07月19日
 *
 */
public interface FileResourceTemplateService extends MsOnionBaseService<FileResourceTemplate, FileResourceTemplateExample> {
     ...
     * @throws MsOnionException                异常
     */
    MsOnionResult saveFileTemplate(MsOnionApiVersion apiVersion, FileResourceTemplate fileResourceTemplate)
     ...
     * @throws MsOnionException                异常
     */
    MsOnionResult updateFileTemplate(MsOnionApiVersion apiVersion, FileResourceTemplate fileResourceTemplate)
            throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @param appPlatform 应用平台
     * @return MsOnionResult 实例
     * @throws MsOnionIllegalArgumentException 异常
     * @throws MsOnionException                异常
     */
    MsOnionResult queryOneTemplate(MsOnionApiVersion apiVersion, Short categoryId, Short appPlatform)
            throws MsOnionIllegalArgumentException, MsOnionException;
