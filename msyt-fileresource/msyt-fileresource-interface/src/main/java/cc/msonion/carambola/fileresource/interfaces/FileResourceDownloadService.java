...
/**
 * @Title: FileResourceDownloadService.java
 * @Package: cc.msonion.carambola.fileresource.interfaces
 * @Description: 文件下载记录 service
...
/**
 * @ClassName: FileResourceDownloadService
 * @Description: 文件下载记录 service
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年05月10日
 *
 */
public interface FileResourceDownloadService extends MsOnionBaseService<FileResourceDownload, FileResourceDownloadExample> {
     ...
     */
    MsOnionResult saveFileResourceDownload(MsOnionApiVersion apiVersion, FileResourceDownload fileResourceDownload)
