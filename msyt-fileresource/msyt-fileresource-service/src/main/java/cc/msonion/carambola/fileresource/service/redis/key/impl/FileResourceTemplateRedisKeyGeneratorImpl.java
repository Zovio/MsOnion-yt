...
/**
 * @Title: FileResourceTemplateRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.fileresource.service.redis.key.impl
 * @Description: 文件模板rediskey生成器
...
/**
 * @ClassName: FileResourceTemplateRedisKeyGeneratorImpl
 * @Description: 文件模板rediskey生成器
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年07月19日
 ...
 */
@Component
public class FileResourceTemplateRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<FileResourceTemplate, FileResourceTemplateExample> {
}
