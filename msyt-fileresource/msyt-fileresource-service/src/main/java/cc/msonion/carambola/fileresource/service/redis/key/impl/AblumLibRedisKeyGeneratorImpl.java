...
/**
 * @Title: AblumLibRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.fileresource.service.redis.key.impl
 * @Description: 相册库redis key生成实现类
...
/**
 * @ClassName: AblumLibRedisKeyGeneratorImpl
 * @Description: 相册库redis key生成实现类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年05月18日
 ...
 */
@Component
public class AblumLibRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<AblumLib, AblumLibExample>  {
