...
/**
 * @Title: FileResourceDownloadRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.fileresource.service.redis.key.impl
 * @Description: 文件资源 下载 redis key生成器
...
/**
 * @ClassName: FileResourceDownloadRedisKeyGeneratorImpl
 * @Description: 文件资源 下载 redis key生成器
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年05月10日
 ...
 */
@Component
public class FileResourceDownloadRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<FileResourceDownload, FileResourceDownloadExample> {
}
