...
/**
 * @Title: LogisticsCustomsDeclareOfficialService.java
 * @Package: cc.msonion.carambola.logistics.service
 * @Description: 正式商品物流报关信息
...
/**
 * @ClassName: LogisticsCustomsDeclareOfficialService
 * @Description: 正式商品物流报关信息
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年06月22日
 */
public interface LogisticsCustomsDeclareOfficialService extends MsOnionBaseService<LogisticsCustomsDeclareOfficial,
        LogisticsCustomsDeclareOfficialExample> {
     ...
     */
    MsOnionResult addLogisticsCustomsDeclareOfficial(MsOnionApiVersion apiVersion,
     ...
     */
    MsOnionResult getLogisticsCustomsDeclareOfficialByItemOfficialIdx(MsOnionApiVersion apiVersion, Long itemOfficialIdx)
            throws MsOnionIllegalArgumentException, MsOnionException;
