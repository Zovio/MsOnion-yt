...
package cc.msonion.carambola.logistics.common.utils;
...
public final class ParamTypeUtils {
     ...
     * 计量单位编码
     */
    public static final int TYPE_UNIT_CODE = 1;

    /**
     * 计量单位名称
     */
    public static final int TYPE_UNIT_NAME = 2;

    static {
        map = new LinkedHashMap<Integer, String>();
        map.put(TYPE_UNIT_CODE, "计量单位编码");
        map.put(TYPE_UNIT_NAME, "计量单位名称");
    }
