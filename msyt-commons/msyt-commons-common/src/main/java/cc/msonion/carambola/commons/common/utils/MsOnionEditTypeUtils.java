...
/**
 * @Title: MsOnionEditTypeUtils.java
 * @Package: cc.msonion.carambola.commons.common.utils
 * @Description: 编辑类型工具类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo johnny-woo@msyc.cc
 * @Date: 2017/5/25 14:04
 * @Version: V2.0.0
 * @Modify-by: JohnnyWoo johnny-woo@msyc.cc
 * @Modify-date: 2017/5/25 14:04
 * @Modify-version: V2.0.0
 * @Modify-description: 编辑类型，1：一次编辑，2：二次编辑，取值范围1-9
 */
...
/**
 * @ClassName: MsOnionEditTypeUtils
 * @Description: 编辑类型工具类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo johnny-woo@msyc.cc
 * @Date: 2017/5/25 14:04
 */
public final class MsOnionEditTypeUtils {
    private MsOnionEditTypeUtils() {
    }
    ...
    /**
     * @Fields EDIT_FIRST : 一次编辑
     */
    public static final Short EDIT_FIRST = 1;

    /**
     * @Fields EDIT_SECOND : 二次编辑
     */
    public static final Short EDIT_SECOND = 2;

    static {
        map = new LinkedHashMap<>();
        map.put(EDIT_FIRST, "一次编辑");
        map.put(EDIT_SECOND, "二次编辑");
    }
