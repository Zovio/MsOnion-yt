...
/**
 * @Title: MsOnionCategoryLevelUtils.java
 ...
 * @Modify-date: 2017/6/6 10:35
 * @Modify-version: V2.0.0
 * @Modify-description: 新增：类目级别：一级类目 1，二级类目 2，三级类目 3
 */
...
/**
 * @ClassName: MsOnionCategoryLevelUtils
 * @Description: 类目级别工具类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo johnny-woo@msyc.cc
 * @Date: 2017/6/6 10:35
 */
public final class MsOnionCategoryLevelUtils {
    private MsOnionCategoryLevelUtils() {
    }
    ...
    /**
     * @Fields LEVEL_FIRST : 一级类目
     */
    public static final Short LEVEL_FIRST = 1;

    /**
     * @Fields LEVEL_SECOND : 二级类目
     */
    public static final Short LEVEL_SECOND = 2;

    /**
     * @Fields LEVEL_THREE : 三级类目
     */
    public static final Short LEVEL_THREE = 3;

    static {
        map = new LinkedHashMap<>();
        map.put(LEVEL_FIRST, "一级类目");
        map.put(LEVEL_SECOND, "二级类目");
        map.put(LEVEL_THREE, "三级类目");
    }
