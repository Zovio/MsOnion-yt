...
public final class PagingConstants {
     ...
     */
    public static final int MS_ONION_PAGING_PAGESIZE_MAX_VALUE = 60;

    /**
     * 分页的每页容量最小值，为：10
     */
    public static final int MS_ONION_PAGING_PAGESIZE_MIN_VALUE = 10;
