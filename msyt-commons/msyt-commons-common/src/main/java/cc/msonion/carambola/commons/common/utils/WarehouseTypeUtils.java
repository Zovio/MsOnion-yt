 ...
 * @Modify-date: 2017/4/6 19:43
 * @Modify-version: V2.0.0
 * @Modify-description: 定义仓库类型
 */
...
/**
 * @ClassName: WarehouseTypeUtils
 * @Description: 仓库类型，1：20仓，2：30仓
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo 3028554324@qq.com
 * @Date: 2017/4/6 19:43
 */
@Deprecated
public final class WarehouseTypeUtils {
    private WarehouseTypeUtils() {
    }
    ...
    /**
     * @Fields WAREHOUSE_20 : 20仓
     */
    public static final Short WAREHOUSE_20 = 1;

    /**
     * @Fields WAREHOUSE_30 : 30仓
     */
    public static final Short WAREHOUSE_30 = 2;

    static {
        map = new LinkedHashMap<>();
        map.put(WAREHOUSE_20, "20仓");
        map.put(WAREHOUSE_30, "30仓");
    }
