...
/**
 * @Title: MsOnionPurchaseStatusUtils.java
 * @Package: cc.msonion.carambola.commons.common.utils
 * @Description: 采购状态常量
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo 3028554324@qq.com
 * @Date: 2017/3/31 15:45
 * @Version: V2.0.0
 * @Modify-by: JohnnyWoo 3028554324@qq.com
 * @Modify-date: 2017/3/31 15:45
 * @Modify-version: V2.0.0
 * @Modify-description: 新增：采购状态，1：未确认采购，2：确认采购
 */
...
/**
 * @ClassName: MsOnionPurchaseStatusUtils
 * @Description: 采购状态，1：未确认采购，2：确认采购
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo 3028554324@qq.com
 * @Date: 2017/3/31 15:45
 */
public final class MsOnionPurchaseStatusUtils {

    private MsOnionPurchaseStatusUtils() {
    }
    ...
    /**
     * @Fields PURCHASE_NOT_CONFIRMED : 未确认采购
     */
    public static final Short PURCHASE_NOT_CONFIRMED = 1;

    /**
     * @Fields PURCHASE_CONFIRMED : 已确认采购
     */
    public static final Short PURCHASE_CONFIRMED = 2;

    static {
        map = new LinkedHashMap<>();
        map.put(PURCHASE_NOT_CONFIRMED, "未确认采购");
        map.put(PURCHASE_CONFIRMED, "已确认采购");
    }
