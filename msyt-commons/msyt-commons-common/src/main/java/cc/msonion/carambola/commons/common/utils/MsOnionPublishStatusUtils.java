...
/**
 * @Title: MsOnionPublishStatusUtils.java
 * @Package: cc.msonion.carambola.commons.common.utils
 * @Description: 发布状态常量
 ...
 * @Modify-date: 2017/7/1 10:27
 * @Modify-version: V2.0.0
 * @Modify-description: 新增：发布状态，1：未发布，2：已发布
 */
...
/**
 * @ClassName: MsOnionPublishStatusUtils
 * @Description: 发布状态，1：未发布，2：已发布
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo johnny-woo@msyc.cc
 * @Date: 2017/7/1 10:27
 */
public final class MsOnionPublishStatusUtils {

    private MsOnionPublishStatusUtils() {
    }
     ...
     * 未发布
     */
    public static final Short PUBLISH_NOT_PUBLISH = 0;

    /**
     * 已发布
     */
    public static final Short PUBLISH_PUBLISHED = 1;

    static {
        map = new LinkedHashMap<>();
        map.put(PUBLISH_NOT_PUBLISH, "未发布");
        map.put(PUBLISH_PUBLISHED, "已发布");
    }
