 ...
 */
package cc.msonion.carambola.thirdplatform.erp.ext.utils;
/**
 * @Title: WarehouseFillData
 * @Package: cc.msonion.carambola.thirdplatform.erp.ext.utils
 * @Description: Warehouse转换
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: DorenWu DorenWu@msyc.cc
 * @Date: 2017年06月12日 11:42:42
 * @Version: V2.0.0
 * @Modify-by: DorenWu DorenWu@msyc.cc
 * @Modify-date: 2017年06月12日 11:42:42
...
/**
 * @ClassName: WarehouseFillData
 * @Description: 描述信息
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: DorenWu DorenWu@msyc.cc
 * @Date: 2017年06月12日 11:42:42
 */
public final  class WarehouseFillData {


    private WarehouseFillData() {
     ...
     * @Description Stock 转换为 Warehouse
     * @param stock api版本
     * @return the ms onion result
     * @Author DorenWu DorenWu@msyc.cc
     * @Date 2017年06月12日 11:46:34
     */
    public static Warehouse stockToWarehouse(Stock stock) {
        final double defaultValue = 0;
        Warehouse warehouse = new Warehouse();
        warehouse.setItemIdx(stock.getGoodsId());
        Double d = MsOnionNumberUtils.toDouble(stock.getStockNum(), defaultValue);
        if (d > defaultValue) {
            warehouse.setRealTimeInventory(d.intValue());
        } else {
