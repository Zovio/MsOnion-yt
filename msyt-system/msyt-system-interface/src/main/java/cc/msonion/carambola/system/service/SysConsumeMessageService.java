...
/**
 * RocketMQ 消费消息 Service
 *
 * @Title: SysConsumeMessageService.java
 * @Package: cc.msonion.carambola.system.service
 ...
 * RocketMQ 消费消息 Service
 *
 * @ClassName: SysConsumeMessageService
 * @Description: RocketMQ 消费消息 Service
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年5月29日 上午10:45:02
 */
public interface SysConsumeMessageService extends MsOnionBaseService<SysConsumeMessage, SysConsumeMessageExample> {
     ...
     */
    MsOnionResult saveMessage(MsOnionApiVersion apiVersion, SysConsumeMessage sysConsumeMessage) throws MsOnionIllegalArgumentException, MsOnionException;
}
