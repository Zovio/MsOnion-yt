 ...
 * @Date: 2017年5月16日 下午13:50:21
 */
public interface ContentImageService extends MsOnionBaseService<ContentImage, ContentImageExample> {
    ...
    */
   MsOnionResult queryContentImageList(MsOnionApiVersion apiVersion, Long contentIdx)
    ...
    */
   MsOnionResult saveContentImageList(MsOnionApiVersion apiVersion, Long contentIdx, Long operateIdx,
    ...
    */
   MsOnionResult updateContentImageList(MsOnionApiVersion apiVersion, Long contentIdx, Long operateIdx,
                  List<ContentImageView> contentImageList)throws MsOnionIllegalArgumentException, MsOnionException;
}
