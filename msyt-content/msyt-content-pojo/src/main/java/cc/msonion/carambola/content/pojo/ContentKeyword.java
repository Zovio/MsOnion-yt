...
public class ContentKeyword implements MsOnionBasePojoAdapter {
    /**
     * 关键词主键idx，分布式架构，全局唯一递增
     */
    private Long idx;
    ...
    /**
     * 关键词，最多50个字符，不可以为null
     */
    @NotNull(message = "关键词不能为空")
    @Length(max = 50, message = "关键词最多50个字符")
    ...
    @Length(max = 1, message = "首字母最多1个字符")
