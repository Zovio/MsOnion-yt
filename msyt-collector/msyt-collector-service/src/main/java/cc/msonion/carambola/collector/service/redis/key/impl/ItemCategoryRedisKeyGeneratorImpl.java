...
/**
 * @Title: ItemCategoryRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.collector.service.impl.redis.key.impl
 * @Description: 商品类目Redis的Key生成器实现类
...
/**
 * @ClassName: ItemCategoryRedisKeyGeneratorImpl
 * @Description: 商品类目Redis的Key生成器实现类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo 3028554324@qq.com
 * @Date: 2017/4/5 20:44
 */
@Component
public class ItemCategoryRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<CollectorItemCategory, CollectorItemCategoryExample> {
