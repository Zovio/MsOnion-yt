...
/**
 * @ClassName: ItemBrandService
 * @Description: 商品品牌Service
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: Johnny woo 3028554324@qq.com
 * @Date: 2017年4月1日 下午2:26:21
 */
public interface ItemBrandService extends MsOnionBaseService<CollectorItemBrand, CollectorItemBrandExample> {
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult addItemBrand(MsOnionApiVersion apiVersion, CollectorItemBrand itemBrand) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult deleteItemBrand(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult updateItemBrand(MsOnionApiVersion apiVersion, CollectorItemBrand itemBrand) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult getItemBrandByIdx(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException                自定义异常
     */
    List<CollectorItemBrand> getAllItemBrand(MsOnionApiVersion apiVersion) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException 自定义异常
     */
    List<CollectorItemBrand> getItemBrandOrderByName(MsOnionApiVersion apiVersion) throws MsOnionException;
}
