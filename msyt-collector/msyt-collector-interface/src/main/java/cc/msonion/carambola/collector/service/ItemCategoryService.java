 ...
 * @Date: 2017年4月1日 下午2:26:21
 */
public interface ItemCategoryService extends MsOnionBaseService<CollectorItemCategory, CollectorItemCategoryExample> {
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult addItemCategory(MsOnionApiVersion apiVersion, CollectorItemCategory itemCategory) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult deleteItemCategory(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult updateItemCategory(MsOnionApiVersion apiVersion, CollectorItemCategory itemCategory)
            throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult getItemCategoryByIdx(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException                自定义异常
     */
    Map<String, Object> getCategoryTree(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException                自定义异常
     */
    List<Map<String, Object>> getCategoryTree(MsOnionApiVersion apiVersion, String code, String name)
            throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     */
    MsOnionResult getCategoryIdxListByPidx(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException                自定义异常
     */
    MsOnionResult getParent(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException                自定义异常
     */
    MsOnionResult getCurrentAndParents(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
