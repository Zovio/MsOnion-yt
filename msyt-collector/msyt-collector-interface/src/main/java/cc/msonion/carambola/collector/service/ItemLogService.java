...
/**
 * @Title: ItemLogService
 * @Package: cc.msonion.carambola.collector.service
 * @Description: 商品日志接口
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: DorenWu DorenWu@msyc.cc
 * @Date: 2017年06月24日 17:13:21
 * @Version: V2.0.0
 * @Modify-by: DorenWu DorenWu@msyc.cc
 * @Modify-date: 2017年06月24日 17:13:21
...
/**
 * @ClassName: ItemLogService
 * @Description: 商品日志接口
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: DorenWu DorenWu@msyc.cc
 * @Date: 2017年06月24日 17:13:21
 */
public interface ItemLogService extends MsOnionBaseService<CollectorItemLog, CollectorItemLogExample> {
     ...
     */
    MsOnionResult saveItemLog(MsOnionApiVersion apiVersion, CollectorItemLog collectorItemLog, Long operateId)
     ...
     */
    MsOnionResult batchSaveItemLog(MsOnionApiVersion apiVersion, List<CollectorItemLog> collectorItemLogList, Long operateId)
            throws MsOnionIllegalArgumentException, MsOnionException;
}
