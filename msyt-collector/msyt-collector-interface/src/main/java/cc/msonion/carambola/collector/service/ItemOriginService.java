...
/**
 * @ClassName: OriginService
 * @Description: 商品产地Service
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: Johnny woo 3028554324@qq.com
 * @Date: 2017年4月1日 下午2:26:21
 */
public interface ItemOriginService extends MsOnionBaseService<CollectorItemOrigin, CollectorItemOriginExample> {
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult addItemOrigin(MsOnionApiVersion apiVersion, CollectorItemOrigin itemOrigin)
            throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException                自定义异常
     */
    MsOnionResult batchDeleteItemOrigin(MsOnionApiVersion apiVersion, String[] ids) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult deleteItemOrigin(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult updateItemOrigin(MsOnionApiVersion apiVersion, CollectorItemOrigin itemOrigin)
            throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @Date 2017年4月1日 下午2:26:21
     */
    MsOnionResult getItemOriginByIdx(MsOnionApiVersion apiVersion, Long idx) throws MsOnionIllegalArgumentException, MsOnionException;
     ...
     * @throws MsOnionException                自定义异常
     */
    List<CollectorItemOrigin> getAllItemOrigin(MsOnionApiVersion apiVersion) throws MsOnionIllegalArgumentException, MsOnionException;
}
