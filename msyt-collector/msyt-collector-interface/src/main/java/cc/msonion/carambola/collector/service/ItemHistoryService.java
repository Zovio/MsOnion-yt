...
/**
 * @ClassName: ItemHistoryService
 * @Description: 商品历史服务
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: JohnnyWoo johnny-woo@msyc.cc
 * @Date: 2017/5/23 12:48
 */
public interface ItemHistoryService extends MsOnionBaseService<CollectorItemHistory, CollectorItemHistoryExample> {
     ...
     */
    MsOnionResult addItemHistory(MsOnionApiVersion apiVersion, CollectorItemHistory itemHistory)
     ...
     * @throws MsOnionException                自定义异常
     */
    MsOnionResult addItemHistory(MsOnionApiVersion apiVersion, CollectorItem item) throws MsOnionIllegalArgumentException, MsOnionException;
