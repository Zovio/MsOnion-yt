...
public class CollectorAttributeGroupAttribute implements MsOnionBasePojoAdapter {
    /**
     * 属性组属性主键idx，分布式架构，全局唯一递增
     */
    private Long idx;
     ...
     */
    @NotNull(message = "属性组不能为空")
    private Long attributeGroupIdx;

    /**
     * 属性主键idx，不可以为null，必须手动设置为0
     */
