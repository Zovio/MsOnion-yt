...
public class CollectorItemContent implements MsOnionBasePojoAdapter {
    /**
     * 商品内容主键idx，分布式架构，全局唯一递增
     */
    private Long idx;
    ...
    /**
     * 图片粘贴区，最多12000个字符，存储富文本编辑器内容
     */
    private String imagePasteArea;
     ...
     * 图片粘贴区，最多12000个字符，存储富文本编辑器内容
     */
    public String getImagePasteArea() {
        return imagePasteArea;
    }

    /**
     * 图片粘贴区，最多12000个字符，存储富文本编辑器内容
     */
    public void setImagePasteArea(String imagePasteArea) {
        this.imagePasteArea = imagePasteArea == null ? null : imagePasteArea.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", imagePasteArea=").append(imagePasteArea);
