...
public class ResourceGroup implements MsOnionBaseCatePojoAdapter {
    /**
     * 资源组主键idx，分布式架构，全局唯一递增
     */
    private Long idx;
    ...
    /**
     * 资源组名称，最少2个字符，最多20个字符
     */
    @NotNull(message = "资源组名称不能为空")
    @Length(max = 20, message = "资源组名称最大20个字符")
    private String name;

    /**
     * 资源组编码，必须全集唯一，建议按照菜单_功能_模块命名，必须是小写字母和_（下划线），最少4字符，最多30个字符
     */
    @Length(max = 30, message = "资源编码名称最大30个字符")
    private String code;
