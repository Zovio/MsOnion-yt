...
public class Department implements MsOnionBaseCatePojoAdapter {
    /**
     * 部门主键idx，分布式架构，全局唯一递增
     */
    private Long idx;
    ...
    @Length(min = 2, max = 20, message = "部门名称最大20个字符，最小2个字符")
    private String name;

    /**
     * 部门编码，必须全集唯一，建议按照菜单_功能_模块命名，必须是小写字母和_（下划线），最少4字符，最多30个字符
     */
    @NotNull(message = "部门编码不能为空")
    @Length(min = 4, max = 30, message = "部门编码最大30个字符，最小4个字符")
    private String code;
    ...
    /**
     * 顺序，取值范围为0-760，不可以为null
     */
    private Short zindex;

    /**
     * 级别，取值范围为0-760，不可以为null
     */
    private Short level;
    ...
    public String toString() {
        ...
        sb.append(", companyIdx=").append(companyIdx);
