...
public class Menu implements MsOnionBaseCatePojoAdapter {
    /**
    ...
    @Length(max = 30, message = "菜单编码最大30个字符")
    private String code;
    ...
    @Length(min = 2, max = 20, message = "菜单名称最小2个字符，最大20个字符")
    private String name;

    /**
     * 菜单Url，最多100个字符，不可以包括中文，父级菜单不可以为null，必须手动初始化为空字符串
     */
    @Length(max = 100, message = "菜单url最大100个字符")
    private String url;
     ...
     */
    @Length(max = 20, message = "菜单备注最大20个字符")
     ...
     * 是否生成默认按钮，0:不生成,1:生成
     */
    public void setMarkButton(Short markButton) {
    ...
    public String toString() {
        ...
        sb.append(", markButton=").append(markButton);
