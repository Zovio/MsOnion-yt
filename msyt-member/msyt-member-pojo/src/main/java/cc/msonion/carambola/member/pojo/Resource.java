...
public class Resource implements MsOnionBaseCatePojoAdapter {
    /**
     * 资源主键idx，分布式架构，全局唯一递增
     */
    private Long idx;
    ...
    /**
     * 资源编码，必须全集唯一，建议按照菜单_功能_模块命名，必须是小写字母和_（下划线），最少4字符，最多30个字符
     */
    private String code;

    /**
     * 资源类型，1:菜单 2：按钮，不能为null
     */
    ...
    /**
     * 状态，1：可用，0：删除，取值范围为0-9，不可以为null
     */
    ...
    /**
     * 备注，字符个数0-20，不可以为null，必须手动设置空字符串
     */
    private String remark;

    /**
     * 扩展字段，先用于当资源类型为按钮时，存入menu idx
     */
    private String ext;
     ...
     * 菜单或者按钮idx，不能为null
     */
    public Long getMenuButtonIdx() {
        return menuButtonIdx;
    }

    /**
     * 菜单或者按钮idx，不能为null
     */
    public void setMenuButtonIdx(Long menuButtonIdx) {
        this.menuButtonIdx = menuButtonIdx;
    }
    ...
    public String toString() {
        ...
        sb.append(", menuButtonIdx=").append(menuButtonIdx);
