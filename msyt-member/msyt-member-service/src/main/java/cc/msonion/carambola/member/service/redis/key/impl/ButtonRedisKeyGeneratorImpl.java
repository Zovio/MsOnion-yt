...
/**
 * @Title: ButtonRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.member.service.redis.key.impl
 * @Description: Button redis生成器
...
/**
 * @ClassName: ButtonRedisKeyGeneratorImpl
 * @Description: Button redis生成器
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年04月05日
 ...
 */
@Component
public class ButtonRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<Button, ButtonExample> {
}
