...
/**
 * @Title: DepartmentRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.member.service.redis.key.impl
 * @Description: redis key实现类
...
/**
 * @ClassName: DepartmentRedisKeyGeneratorImpl
 * @Description: redis key实现类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年04月06日
 ...
 */
@Component
public class DepartmentRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<Department, DepartmentExample> {
