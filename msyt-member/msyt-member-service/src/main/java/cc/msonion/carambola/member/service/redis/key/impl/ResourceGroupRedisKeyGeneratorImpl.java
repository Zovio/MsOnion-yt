...
/**
 * @Title: ResourceGroupRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.member.service.redis.key.impl
...
/**
 * @ClassName: ResourceGroupRedisKeyGeneratorImpl
 * @Description: redis 生成器实现类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年04月07日
 */
@Component
public class ResourceGroupRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<ResourceGroup, ResourceGroupExample> {
