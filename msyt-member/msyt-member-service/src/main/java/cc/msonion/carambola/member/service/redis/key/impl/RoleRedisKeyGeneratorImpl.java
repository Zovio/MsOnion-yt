...
/**
 * @Title: RoleRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.member.service.redis.key.impl
 * @Description: 角色 redis ke生成器实现
...
/**
 * @ClassName: RoleRedisKeyGeneratorImpl
 * @Description: 角色 redis 生成器实现
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年04月06日
 *
 */
@Component
public class RoleRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<Role, RoleExample> {
