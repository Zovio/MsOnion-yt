...
/**
 * @Title: MenuRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.member.service.redis.key.impl
 * @Description: 菜单 redis 的key生成器实现类
...
/**
 * @ClassName: MenuRedisKeyGeneratorImpl
 * @Description: 菜单 redis 的key生成器实现类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年03月31日
 ...
 */
@Component
public class MenuRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<Menu, MenuExample> {
}
