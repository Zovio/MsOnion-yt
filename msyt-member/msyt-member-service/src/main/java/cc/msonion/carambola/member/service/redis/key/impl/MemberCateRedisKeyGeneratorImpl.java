...
/**
 * @Title: MemberCateRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.member.service.redis.key.impl
 * @Description: 用户组 redis生成器实现类
...
/**
 * @ClassName: MemberCateRedisKeyGeneratorImpl
 * @Description: 用户组 redis生成器实现类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年04月06日
 ...
 */
@Component
public class MemberCateRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<MemberCate, MemberCateExample> {
}
