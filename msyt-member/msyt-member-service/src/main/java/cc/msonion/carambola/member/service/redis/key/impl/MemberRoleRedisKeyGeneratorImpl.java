...
/**
 * @Title: MemberRoleRedisKeyGeneratorImpl.java
 * @Package: cc.msonion.carambola.member.service.redis.key.impl
...
/**
 * @ClassName: MemberRoleRedisKeyGeneratorImpl
 * @Description: redis 生成器实现类
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: liaoxf
 * @Date: 2017年04月06日
 ...
 */
@Component
public class MemberRoleRedisKeyGeneratorImpl extends MsOnionRedisKeyGenerator<MemberRole, MemberRoleExample> {
