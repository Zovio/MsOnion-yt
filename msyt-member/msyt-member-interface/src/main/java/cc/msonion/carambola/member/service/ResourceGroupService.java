...
/**
 * @Title: ResourceGroupService.java
 * @Package: cc.msonion.carambola.member.service
 ...
 *
 */
public interface ResourceGroupService extends MsOnionBaseService<ResourceGroup, ResourceGroupExample> {
     ...
     *
     * @param apiVersion Api版本
     * @param resourceGroup 资源组实例
     * @return MsOnionResult 实例
     * @throws MsOnionIllegalArgumentException 异常
     * @throws MsOnionException 异常
     */
    MsOnionResult saveOrUpdate(MsOnionApiVersion apiVersion, ResourceGroup resourceGroup) throws MsOnionIllegalArgumentException, MsOnionException;
