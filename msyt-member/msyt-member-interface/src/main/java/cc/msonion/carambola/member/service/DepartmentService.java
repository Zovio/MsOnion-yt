 ...
 *
 */
public interface DepartmentService extends MsOnionBaseService<Department, DepartmentExample> {
     ...
     * @throws MsOnionException 异常
     */
    MsOnionResult saveOrUpdate(MsOnionApiVersion apiVersion, Department department) throws MsOnionIllegalArgumentException, MsOnionException;
