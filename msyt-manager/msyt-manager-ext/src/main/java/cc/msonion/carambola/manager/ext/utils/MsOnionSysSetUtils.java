 ...
 *
 */
public final class MsOnionSysSetUtils {

    private MsOnionSysSetUtils() {

    }

    /**
     * 获取系统设置value
     * @param sysSettingService 系统设置
     * @param msOnionApiVersion 版本号
     * @param setKey 字典编码
     * @return value , not found return null
     * @throws MsOnionException 异常
     */
    public static String getSysValueBySetKey(SysSettingService sysSettingService,
                                             MsOnionApiVersion msOnionApiVersion, String setKey) throws MsOnionException {
        MsOnionResult result = sysSettingService.getValueBySetKey(msOnionApiVersion, setKey);
    ...
    /**
     * 获取数据字典Map
     * @param sysDataDictionaryService 数据字典服务
     * @param apiVersion 版本号
     * @param dictCode 字典编码
     * @return 字典map
     * @throws MsOnionException 异常
     */
    public static Map getDictMap(SysDataDictionaryService sysDataDictionaryService, String apiVersion, String dictCode) throws MsOnionException {
        MsOnionApiVersion msOnionApiVersion = MsOnionApiVersionUtils.getApiVersion();
        msOnionApiVersion.setRequestApiVersion(apiVersion);
        return sysDataDictionaryService.getDictMap(msOnionApiVersion, dictCode);
    }
