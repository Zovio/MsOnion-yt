...
/**
 * @Title: ItemExcelServiceImpl
 * @Package: cc.msonion.carambola.manager.web.controller.excel.impl
 * @Description: 描述信息
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: DorenWu DorenWu@msyc.cc
 * @Date: 2017年06月21日 17:18:32
 * @Version: V2.0.0
 * @Modify-by: DorenWu DorenWu@msyc.cc
 * @Modify-date: 2017年06月21日 17:18:32
...
/**
 * @ClassName: ItemExcelServiceImpl
 * @Description: 商品Excel导入
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: DorenWu DorenWu@msyc.cc
 * @Date: 2017年06月21日 17:18:32
 */
public class ItemExcelServiceImpl implements MsOnionExcelDataService {
    ...
    public ItemExcelServiceImpl(Member currentUser, ItemService itemService, MsOnionApiVersion apiVersion, MsOnionLogger msOnionLogger) {
    ...
    public List writeToDataBases(List dataObjectList) {
        MsOnionResult batchNewItemViewResult = itemService.
                batchItemView(apiVersion, dataObjectList, currentUser.getIdx());
        dataObjectList = (List<ExcelItemView>) batchNewItemViewResult.getData();
    ...
    public List<String> getTemplateTitle() {
        ...
        return Arrays.asList(ManagerConstants.EXCEL_TEMPLATE_ITEM_TITLE);
    }
}
