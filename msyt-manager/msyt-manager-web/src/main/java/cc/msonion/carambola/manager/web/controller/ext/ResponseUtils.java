...
public final class ResponseUtils {
     ...
     * @return 响应对象
     */
    public static HttpServletResponse setDownLoadResponse(HttpServletRequest request,
                                                          HttpServletResponse response, String fileName) throws MsOnionException {
