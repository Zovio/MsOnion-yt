...
package cc.msonion.carambola.manager.web.mq.rocketmq.messagelistener;
 ...
 *
 * @Title: ManagerConcurrentlyMessageListener.java
 * @Package: cc.msonion.carambola.manager.web.mq.rocketmq.messagelistener
...
/**
 * RocketMQ Push 消费者，普通消息（无序消息）监听器
 * @ClassName: ManagerConcurrentlyMessageListener
 * @Description: ManagerConcurrentlyMessageListener
 * @Company: 广州市两棵树网络科技有限公司
 * @Author: HeroCao hero-cao@msyc.cc
 * @Date: 2017年5月30日 下午5:11:38
 */
public class ManagerConcurrentlyMessageListener implements MsOnionRocketMQMessageListenerConcurrently {
